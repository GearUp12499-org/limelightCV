...
def detect(img, color):
    ...
    for c in contours:
        ...
        # if the rectangle is too big, draw it in light blue
    ...
    if len(samples_found) == 0:
        ...
        return x_offset_in, y_offset_in, samples_found[0][3], rect_vals
...
# img = cv2.imread("D:/Gear Up/limelightCV/nishk04/images/pic121.png")
# _, _, llpython = runPipeline(img, [1.0, 1.0, 1.0]) # Yellow - Blue - Red
# print(llpython[:4])
# cv2.waitKey(0)
# cv2.destroyAllWindows()
